export const CONTRACT_ABI = [
  ...
  "function quoteSellPredictionForUser(uint256 _marketId, uint256 _eventId, uint8 _choice, address _user, uint256 _amount) external view returns (uint256 exitPriceBps, uint256 grossPayout, uint256 fee, uint256 netPayout)",
  ...
  "event PredictionSold(uint256 indexed marketId, uint256 indexed eventId, address indexed user, uint8 choice, uint256 amount, uint256 grossPayout, uint256 fee, uint256 netPayout, uint256 exitPriceBps)",
